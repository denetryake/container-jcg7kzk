...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jcg7kzk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jcg7kzk.containers.anotherwebservice.com/
...
```
git clone git@github.com:denetryake/container-jcg7kzk.git
cd container-jcg7kzk
```
...
```
docker attach container-jcg7kzk
```
